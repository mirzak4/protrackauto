...
@Component({
  selector: 'app-driver-fines',
  imports: [CommonModule],
  templateUrl: './driver-fines.component.html',
  styleUrl: './driver-fines.component.css'
})
export class DriverFinesComponent implements OnInit{
  driverId!: number;
  fines: TrafficFine[] = [];
  ...
  loadFines() {
    this.fineService.getByDriverId(this.driverId).subscribe({
      next: (fines) => {
        this.fines = fines;
      },
