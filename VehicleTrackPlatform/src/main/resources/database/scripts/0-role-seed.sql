        ...
        BEGIN
            ...
            BEGIN
                ...
                IF EXEC_COUNT = 0 THEN
                    ...
                    --    INSERT INTO nbp.nbp_role (NAME) VALUES ('NBP04.CLAIMS_ADJUSTER') RETURNING id INTO CLAIMS_ADJUSTER_ID;
                    --END;

                    --DECLARE FIELD_TECHNICIAN_ID INTEGER;
                    --BEGIN
                        -- Employee in Service Provider Company
                    --    INSERT INTO nbp.nbp_role (NAME) VALUES ('NBP04.FIELD_TECHNICIAN') RETURNING id INTO FIELD_TECHNICIAN_ID;
                    --END;

                    --DECLARE STATION_MANAGER_ID INTEGER;
                    --BEGIN
                        -- Employee in Gas Station Company
                    --    INSERT INTO nbp.nbp_role (NAME) VALUES ('NBP04.STATION_MANAGER') RETURNING id INTO STATION_MANAGER_ID;
                    --END;

                    --DECLARE DRIVER_ID INTEGER;
                    --BEGIN
                        -- Driver
                    --    INSERT INTO nbp.nbp_role (NAME) VALUES ('NBP04.DRIVER') RETURNING id INTO DRIVER_ID;
                    --END;

                    --DECLARE ADMIN_ID INTEGER;
                    --BEGIN
                        -- Driver
                    --    INSERT INTO nbp.nbp_role (NAME) VALUES ('NBP04.ADMIN') RETURNING id INTO ADMIN_ID;
                    --END;
