            ...
            BEGIN
                ...
                IF EXEC_COUNT = 0 THEN
                    ...
                    BEGIN
                        ...
                        VALUES
                          (FULL_NAME, DATE '2025-03-15', 'Sarajevo', 'Mostar', DATE '2025-04-01', DATE '2025-04-01', 1, V1, D1);

                        INSERT INTO TRAVEL_REQUEST
                          (APPROVED_BY, APPROVAL_DATE, DEPARTURE_LOCATION, DESTINATION, START_DATE, END_DATE, REQUEST_STATUS, VEHICLE_ID, DRIVER_ID)
                        VALUES
                          (FULL_NAME, DATE '2025-03-16', 'Zenica', 'Tuzla', DATE '2025-04-05', DATE '2025-04-05', 2, V2, D2);

                        INSERT INTO TRAVEL_REQUEST
                          (APPROVED_BY, APPROVAL_DATE, DEPARTURE_LOCATION, DESTINATION, START_DATE, END_DATE, REQUEST_STATUS, VEHICLE_ID, DRIVER_ID)
                        VALUES
                          (FULL_NAME, DATE '2025-03-17', 'Banja Luka', 'Sarajevo', DATE '2025-04-10', DATE '2025-04-10', 3, V3, D1);

                        INSERT INTO TRAVEL_REQUEST
                          (APPROVED_BY, APPROVAL_DATE, DEPARTURE_LOCATION, DESTINATION, START_DATE, END_DATE, REQUEST_STATUS, VEHICLE_ID, DRIVER_ID)
                        VALUES
                          (FULL_NAME, DATE '2025-03-18', 'Mostar', 'Bihać', DATE '2025-04-15', DATE '2025-04-16', 4, V4, D2);

                        INSERT INTO TRAVEL_REQUEST
                          (APPROVED_BY, APPROVAL_DATE, DEPARTURE_LOCATION, DESTINATION, START_DATE, END_DATE, REQUEST_STATUS, VEHICLE_ID, DRIVER_ID)
                        VALUES
                          (FULL_NAME, DATE '2025-03-19', 'Sarajevo', 'Mostar', DATE '2025-04-20', DATE '2025-04-20', 5, V5, D1);

                        INSERT INTO TRAVEL_REQUEST
                          (APPROVED_BY, APPROVAL_DATE, DEPARTURE_LOCATION, DESTINATION, START_DATE, END_DATE, REQUEST_STATUS, VEHICLE_ID, DRIVER_ID)
                        VALUES
                          (FULL_NAME, DATE '2025-03-20', 'Zenica', 'Banja Luka', DATE '2025-04-25', DATE '2025-04-25', 6, V6, D2);

                        INSERT INTO TRAVEL_REQUEST
                          (APPROVED_BY, APPROVAL_DATE, DEPARTURE_LOCATION, DESTINATION, START_DATE, END_DATE, REQUEST_STATUS, VEHICLE_ID, DRIVER_ID)
                        VALUES
                          (FULL_NAME, DATE '2025-03-21', 'Tuzla', 'Mostar', DATE '2025-05-01', DATE '2025-05-01', 1, V7, D1);

                        INSERT INTO TRAVEL_REQUEST
                          (APPROVED_BY, APPROVAL_DATE, DEPARTURE_LOCATION, DESTINATION, START_DATE, END_DATE, REQUEST_STATUS, VEHICLE_ID, DRIVER_ID)
                        VALUES
                          (FULL_NAME, DATE '2025-03-22', 'Bihać', 'Sarajevo', DATE '2025-05-05', DATE '2025-05-06', 2, V8, D2);

                        INSERT INTO TRAVEL_REQUEST
                          (APPROVED_BY, APPROVAL_DATE, DEPARTURE_LOCATION, DESTINATION, START_DATE, END_DATE, REQUEST_STATUS, VEHICLE_ID, DRIVER_ID)
                        VALUES
                          (FULL_NAME, DATE '2025-03-23', 'Mostar', 'Zenica', DATE '2025-05-10', DATE '2025-05-10', 3, V9, D1);

                        INSERT INTO TRAVEL_REQUEST
                          (APPROVED_BY, APPROVAL_DATE, DEPARTURE_LOCATION, DESTINATION, START_DATE, END_DATE, REQUEST_STATUS, VEHICLE_ID, DRIVER_ID)
                        VALUES
                          (FULL_NAME, DATE '2025-03-24', 'Tuzla', 'Banja Luka', DATE '2025-05-15', DATE '2025-05-15', 4, V10, D2);

                        INSERT INTO TRAVEL_REQUEST
                          (APPROVED_BY, APPROVAL_DATE, DEPARTURE_LOCATION, DESTINATION, START_DATE, END_DATE, REQUEST_STATUS, VEHICLE_ID, DRIVER_ID)
                        VALUES
                          (FULL_NAME, DATE '2025-03-25', 'Sarajevo', 'Banja Luka', DATE '2025-05-15', DATE '2025-05-15', 5, V11, D3);

                        INSERT INTO TRAVEL_REQUEST
                          (APPROVED_BY, APPROVAL_DATE, DEPARTURE_LOCATION, DESTINATION, START_DATE, END_DATE, REQUEST_STATUS, VEHICLE_ID, DRIVER_ID)
                        VALUES
                          (FULL_NAME, DATE '2025-03-26', 'Mostar', 'Trebinje', DATE '2025-06-05', DATE '2025-06-05', 6, V12, D5);

                        INSERT INTO TRAVEL_REQUEST
                          (APPROVED_BY, APPROVAL_DATE, DEPARTURE_LOCATION, DESTINATION, START_DATE, END_DATE, REQUEST_STATUS, VEHICLE_ID, DRIVER_ID)
                        VALUES
                          (FULL_NAME, DATE '2025-03-25', 'Zenica', 'Tuzla', DATE '2025-05-18', DATE '2025-05-18', 5, V13, D3);

                        INSERT INTO TRAVEL_REQUEST
                          (APPROVED_BY, APPROVAL_DATE, DEPARTURE_LOCATION, DESTINATION, START_DATE, END_DATE, REQUEST_STATUS, VEHICLE_ID, DRIVER_ID)
                        VALUES
                          (FULL_NAME, DATE '2025-03-26', 'Bihać', 'Sarajevo', DATE '2025-06-10', DATE '2025-06-10', 6, V14, D6);

                        INSERT INTO TRAVEL_REQUEST
                          (APPROVED_BY, APPROVAL_DATE, DEPARTURE_LOCATION, DESTINATION, START_DATE, END_DATE, REQUEST_STATUS, VEHICLE_ID, DRIVER_ID)
                        VALUES
                          (FULL_NAME, DATE '2025-03-26', 'Doboj', 'Brčko', DATE '2025-06-08', DATE '2025-06-08', 6, V15, D4);

                        INSERT INTO TRAVEL_REQUEST
                          (APPROVED_BY, APPROVAL_DATE, DEPARTURE_LOCATION, DESTINATION, START_DATE, END_DATE, REQUEST_STATUS, VEHICLE_ID, DRIVER_ID)
                        VALUES
                          (FULL_NAME, DATE '2025-03-25', 'Tuzla', 'Zvornik', DATE '2025-05-22', DATE '2025-05-22', 5, V16, D3);

                        INSERT INTO TRAVEL_REQUEST
                          (APPROVED_BY, APPROVAL_DATE, DEPARTURE_LOCATION, DESTINATION, START_DATE, END_DATE, REQUEST_STATUS, VEHICLE_ID, DRIVER_ID)
                        VALUES
                          (FULL_NAME, DATE '2025-03-26', 'Mostar', 'Konjic', DATE '2025-06-15', DATE '2025-06-15', 6, V17, D4);

                        INSERT INTO TRAVEL_REQUEST
                          (APPROVED_BY, APPROVAL_DATE, DEPARTURE_LOCATION, DESTINATION, START_DATE, END_DATE, REQUEST_STATUS, VEHICLE_ID, DRIVER_ID)
                        VALUES
                          (FULL_NAME, DATE '2025-03-25', 'Sarajevo', 'Jajce', DATE '2025-05-25', DATE '2025-05-25', 5, V18, D5);

                        INSERT INTO TRAVEL_REQUEST
                          (APPROVED_BY, APPROVAL_DATE, DEPARTURE_LOCATION, DESTINATION, START_DATE, END_DATE, REQUEST_STATUS, VEHICLE_ID, DRIVER_ID)
                        VALUES
                          (FULL_NAME, DATE '2025-03-26', 'Banja Luka', 'Prijedor', DATE '2025-06-18', DATE '2025-06-18', 6, V19, D6);

                        INSERT INTO TRAVEL_REQUEST
                          (APPROVED_BY, APPROVAL_DATE, DEPARTURE_LOCATION, DESTINATION, START_DATE, END_DATE, REQUEST_STATUS, VEHICLE_ID, DRIVER_ID)
                        VALUES
                          (FULL_NAME, DATE '2025-03-26', 'Trebinje', 'Neum', DATE '2025-06-20', DATE '2025-06-20', 6, V20, D5);
                    END;
